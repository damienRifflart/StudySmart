    ...
    return (
        ...
        {!homework.done ? (
            <div className='w-[280px] bg-secondary rounded-lg mr-3 mb-3 relative' >
                <div className="flex flex-col m-3 text-xl font-medium text-secondary-foreground">
                    <p className='whitespace-pre-wrap break-words mt-2'>{homework.subject}</p>
                    <p className='whitespace-pre-wrap break-words font-normal'>{homework.description}</p>
                    <div className="flex flex-row items-center mt-4 mb-2 font-normal">
